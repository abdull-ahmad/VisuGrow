    ...
    <div>
      <div className='header flex flex-row w-full justify-between'>
        ...
        <div className='flex flex-row justify-end items-center w-1/5'>
          <button className='customColorButton font-rowdies text-white text-l p-2 m-2 rounded-3xl w-2/3 h-1/2 gap-2'>
            signup
          </button>
          <button className='customColorButton font-rowdies text-white text-l p-2 m-2 rounded-3xl w-2/3 h-1/2 gap-2'>
            signin
      ...
      <div className='flex flex-row justify-between items-center px-20'>
        <div className='flex flex-col justify-center items-center '>
          ...
          <button className='customColorButton font-rowdies text-white text-l p-2 mt-5 rounded-3xl w-1/3 h-1/2 gap-2 text-center'>
            Get Started
          </button>
        </div>
        <div>
