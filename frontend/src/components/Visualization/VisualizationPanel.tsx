...
export const VisualizationPanel: React.FC<VisualizationPanelProps> = ({
  ...
  const handleDateFilterChange = (chartId: string, filterType: 'year' | 'month' | 'week' | 'day') => {
    updateChart(chartId, { dateFilterType: filterType });
  };

  const handleNumberFilterChange = (chartId: string, filterType: 'increasing' | 'decreasing') => {
                            ...
                            {selectedChart.yParameter && getParameterType(selectedChart.yParameter) === 'number' && (
                              <div className="mt-3 p-2 bg-white rounded border border-gray-200">
                                ...
                                <div className="grid grid-cols-2 gap-1">
                                  ...
                                  >
                                    <ArrowUp size={14} className="mr-1" /> Ascending
                                  </button>
                                  <button
                                  ...
                                  >
                                    <ArrowDown size={14} className="mr-1" /> Descending
                                  </button>
                                </div>
                              </div>
                            )}
